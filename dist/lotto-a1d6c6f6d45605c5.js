 ...
 * @returns {any}
 */
export function generate_lotto_numbers() {
    const ret = wasm.generate_lotto_numbers();
    return ret;
}
 ...
 * @returns {any}
 */
export function generate_lotto_numbers_wasm() {
    const ret = wasm.generate_lotto_numbers_wasm();
    return ret;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('lotto_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
